...
import {fields,options} from './confirmation.form';
...
export class ConfirmationService {
  ...
  async confirmation(){
    ...
    this.authService.confirmation(this._model.userName,this._model.password,this._user.id).subscribe( async(response)=>{
      this.login();
    },error =>{
            this._invalidUser = true;
    });
