export const environment = {
  production: true,
  URL_API: "http://gisnet-security-qtpbvzhgtn.dynamic-m.com:9093/api-gpc/api",
  URL_API_AUTH: "http://gisnet-security-qtpbvzhgtn.dynamic-m.com:9093/api-gpc/oauth/token",
